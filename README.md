...
A connection is a relationship between Auth0 and a source of users. In this [Okta Learning](https://learning.okta.com) hands-on lab, learners will practice the necessary steps to configure database and passwordless connections.
